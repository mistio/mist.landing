    ...
    <div id="features" style="position:relative;">
        <table id="table" class="grid-container">
            <tr>
                ...
                <td class="grid-cell"><strong>LDAP Integration</strong><br/><span class="secondary">Authenticate users using LDAP</span></td>
                <td class="grid-cell c"><iron-icon icon="clear" title="Not supported"></iron-icon></td>
                <td class="grid-cell c"><iron-icon icon="clear" title="Not supported"></iron-icon></td>
                <td class="grid-cell c"><iron-icon icon="done" title="Supported"></iron-icon></td>
            </tr><tr>
                <td class="grid-cell"><strong>Active Directory Integration</strong><br/><span class="secondary">Get your teams and users from AD to Mist.</span></td>
                <td class="grid-cell c"><iron-icon icon="clear" title="Not supported"></iron-icon></td>
                <td class="grid-cell c"><iron-icon icon="clear" title="Not supported"></iron-icon></td>
                <td class="grid-cell c"><iron-icon icon="done" title="Supported"></iron-icon></td>
            </tr><tr>
