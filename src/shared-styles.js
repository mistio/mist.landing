...
$_documentContainer.innerHTML = `<dom-module id="shared-styles">
    <template>
        ...
        .contact paper-button.btn-bordered {
        ...
        #pricing .plan-body-item + .plan-body-item {
        ...
        @media screen and (max-width: 768px){
            ...
            #pricing .includes ul, .includes li {
                margin: 0;
                padding: 0;
            }
        }
